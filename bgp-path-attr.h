...
int parse_bgp_path_attr_community(char **buffer, int *buffer_size, uint8_t *input, int len, bool as_hex);
int parse_bgp_path_attr_nexthop(char *buffer, int remaining, uint8_t *input, int len);
int parse_bgp_path_attr_aspath(char **buffer, int *buffer_size, uint8_t *input, int len, bool as_hex);
